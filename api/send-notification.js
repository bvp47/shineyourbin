...
function getPaymentMethodText(method) {
  switch(method) {
    case 'cash': return 'Cash (paid at time of service)';
    case 'card': return 'Credit/Debit Card (invoice will be sent)';
    case 'venmo': return 'Venmo (invoice will be sent)';
    case 'apple-pay': return 'Apple Pay (invoice will be sent)';
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #6b7280;">
            ...
            <p style="margin: 5px 0;"><strong>💳 Payment Method:</strong> ${getPaymentMethodText(bookingData.payment_method)}</p>
